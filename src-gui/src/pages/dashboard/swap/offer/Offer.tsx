...
export default function Offer({ onBack, onNext }: { onBack: () => void; onNext: () => void }) {
    ...
    return (
        <>
        <DialogContent>
            <Typography variant="body1">Confirm your offer to start the swap</Typography>
            <MakerOfferItem />

            <Box sx={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 2, mt: 2 }}>
                <Typography variant="body1">You send</Typography>
                <Typography sx={{ textAlign: 'right' }} variant="body1">0.00002 BTC</Typography>
                <Divider sx={{ gridColumn: 'span 2' }} />

                <Box sx={{ display: 'flex', alignItems: 'center', gap: 0.5 }}>
                    <Typography variant="body1">Fee</Typography>
                    <IconButton onClick={() => setFeeExpanded(!feeExpanded)} disableFocusRipple>
                ...
                {feeExpanded && (
                    <>
                        ...
                        <Typography sx={{ textAlign: 'right' }} variant="body2">0.00002 BTC</Typography>

                        <Typography variant="body2">Exchange Fee</Typography>
                        <Typography sx={{ textAlign: 'right' }} variant="body2">0.00002 BTC</Typography>

                        <Typography variant="body2">Monero Transaction Fee</Typography>
                        <Typography sx={{ textAlign: 'right' }} variant="body2">0.00002 XMR</Typography>
                ...
                <Typography sx={{ textAlign: 'right' }} variant="body1">0.00002 XMR</Typography>
            </Box>
