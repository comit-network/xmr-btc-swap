...
/// the encsig and fail to refund or redeem. Alice punishes. Bob then asks Alice to give him the XMR key.
#[tokio::test]
async fn alice_punishes_if_bob_never_acts_after_fund_bob_then_asks_alice_xmr_key() {
