...
mod tests {
    ...
    async fn test_insert_and_load_state() {
        ...
        db.insert_latest_state( swap_id_1, state_1.clone()).await.unwrap();
    ...
    async fn test_retrieve_all_latest_states() {
        ...
        db.insert_latest_state(swap_id_1, state_1.clone()).await.unwrap();
        db.insert_latest_state(swap_id_1, state_2.clone()).await.unwrap();
        db.insert_latest_state(swap_id_1, state_3.clone()).await.unwrap();
        db.insert_latest_state(swap_id_2, state_4.clone()).await.unwrap();
