...
pub enum Options {
    ...
    Bob {
        // TODO: Remove - Seems this is not needed anymore...?
        // #[structopt(long = "sats")]
        // satoshis: u64,
...
// TODO (Daniel): Potentially find a way to remove the Result here, it should
// not be needed for the conversion,  but could not figure out fast how to fix
// this with structopt
